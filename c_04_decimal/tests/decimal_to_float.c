...
START_TEST(s21_from_decimal_to_floatTest1) {
  ...
  float src2;
  float *srcp = &src2;
  // s21_decimal src1 = 2546.5= {{0, 0, 0, 0}};
...
START_TEST(s21_from_decimal_to_floatTest2) {
  ...
  float src2;
  float *srcp = &src2;
  // s21_decimal src1 = -0.46453= {{0, 0, 0, 0}};
...
START_TEST(s21_from_decimal_to_floatTest6) {
  ...
  float src2;
  float *srcp = &src2;
  // s21_decimal src1 = -5.49265= {{0, 0, 0, 0}};
...
START_TEST(s21_from_decimal_to_floatTest7) {
  ...
  float src2;
  float *srcp = &src2;
  // s21_decimal src1 = 2.5086531268974139743= {{0, 0, 0, 0}};
